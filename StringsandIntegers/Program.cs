        ...
        static void Main(string[] args)
        {
            ...
            while (!numValid)
            {
                ...
                try
                {
                    ...
                    //Dividing each number in the list the input
                    else
                    {
            ...
            //Message to let user know that rogram has exited the try/catch block
            Console.WriteLine("The program has exited the trycatch block.");
        }
    }
}
